...
#         cs1 = example_link_layer.compute_checksum(base_body)
#         cs2 = example_link_layer.compute_checksum(body_with_different_seq)
#
...
#         cs1 = example_link_layer.compute_checksum(base_body)
#         cs2 = example_link_layer.compute_checksum(body_with_islast_0)
#
#         assert not np.all(cs1 == cs2)
#
...
#         cs1 = example_link_layer.compute_checksum(base_body)
#         cs2 = example_link_layer.compute_checksum(body_with_isack_1)
#
#         assert not np.all(cs1 == cs2)
#
...
#         cs1 = example_link_layer.compute_checksum(base_body)
#         cs2 = example_link_layer.compute_checksum(body_with_different_real_length)
#
#         assert not np.all(cs1 == cs2)
#
...
#         cs1 = example_link_layer.compute_checksum(base_body)
#         cs2 = example_link_layer.compute_checksum(body_with_different_payload)
#
#         assert not np.all(cs1 == cs2)
#
#
